...
export const environment = {
  ...
  apiGatewaySettings: {
    endpointUrl: 'https://edge.hedge.earth/emissionless/rollthecloudinc/test-automation107-objects-prod/shapeshifter',
  },
  mediaSettings: {
    ...
    imageUrl: 'https://edge.hedge.earth/emissionless/test-automation107',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/test-automation107-objects-prod'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-prod-o5unofrr3c4qb3ykfrxebh2e4a'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://test-automation107.druidcloud.io/auth-callback',
    silent_redirect_uri: 'https://test-automation107.druidcloud.io/silent-refresh.html',
    response_type: "code",

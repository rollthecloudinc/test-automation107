...
export const environment = {
  production: false,
  site: 'test-automation107',
  apiGatewaySettings: {
    // endpointUrl: 'https://localhost:44340',
    endpointUrl: "https://vertigo.druidcloud.dev/rollthecloudinc/test-automation107-objects/shapeshifter"
  },
  mediaSettings: {
    endpointUrl: 'https://vertigo.druidcloud.dev/test-automation107/media',
    cloudinaryUrl: 'https://api.cloudinary.com/v1_1/dj4vvkgzw',
    uploadPreset: 'i0hm4opm',
    imageUrl: 'https://vertigo.druidcloud.dev/test-automation107',
  ...
  panelsSettings: {
    ...
    objectsRootUrl: 'https://rollthecloudinc.github.io/test-automation107-objects'
  },
  alienaliasSettings: {
    openSearchDomain: 'search-classifieds-ui-dev-eldczuhq3vesgpjnr3vie6cagq'
  },
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://test-automation107.druidcloud.dev/auth-callback',
    silent_redirect_uri: 'https://test-automation107.druidcloud.dev/silent-refresh.html',
    response_type: "code",
